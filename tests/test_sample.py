...
def test_sample():
    ...
    assert txn_2.date == date(2026, 3, 2)
    ...
    assert txn_3.date == date(2026, 3, 2)
    ...
    assert txn_4.date == date(2026, 3, 2)
    ...
    assert txn_5.date == date(2026, 3, 2)
    ...
    assert txn_6.date == date(2026, 3, 2)
    ...
    assert txn_7.date == date(2026, 3, 2)
